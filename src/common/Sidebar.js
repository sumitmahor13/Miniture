  ...
  return (
    <div>
      ...
      >
        ...
        <div className="p-4">
          <span className="absolute cursor-pointer top-0 right-0 p-4" onClick={closeSidebar}>
            <FaTimes />
          </span>
          ...
          {cartProducts.length === 0 ? (
            ...
            <div>
                ...
                <div className="flex justify-between mb-4" key={key}>
                  <div className="flex">
                    <div className="relative">
                      ...
                      <span
                        className="absolute top-0 -mt-2 -ml-2 cursor-pointer bg-red-600 text-white"
                    ...
                    <div className='px-3'>
                      ...
                      <p className="text-green-600">Price: {(item.price).toLocaleString('en-IN')}</p>
              ...
              <div className="flex p-6 items-center bg-black w-full text-white font-bold">
                <h2>
                  Sub Total : <span>₹{(totalAmount).toLocaleString('en-IN')}</span>
                </h2>
                <div className="ml-4 btn rounded-sm py-3 px-6 text-black">
