          ...
          <div className="modal-content w-2/3 relative bg-white overflow-hidden">
            ...
            <div className="flex">
              ...
              <div className="modal-info ml-6">
                ...
                <p className="text-[#2a31ff] font-bold text-2xl">₹{(data.price).toLocaleString('en-IN')}</p>
                <p className="my-2">{data.description}Read more</p>
                ...
                <div className="flex items-center mb-2">
                  ...
                  >
                    <option value="options" hidden>Choose an Options</option>
                    <option value="options">{data.option1}</option>
                    <option value="options"> {data.option2}</option>
                    <option value="options">{data.option3}</option>
                    <option value="options">{data.option4}</option>
                  </select>
                </div>
