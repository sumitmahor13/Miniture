            ...
            <div>
                  ...
                  <tbody>
                    {cartProducts.map((item, key) => (
                      <tr key={key}>
                        ...
                        <td className="text-center px-4 py-2">₹{(item.price).toLocaleString('en-IN')}</td>
                        <td className="text-center px-4 py-2">
              ...
              <div className="p-6 w-2/5 rounded-2xl shadow-2xl bg-white font-bold mt-4">
                ...
                <div className="flex justify-between mt-3">
                  Shipping Charge : <span>₹{99}</span>
                </div>

                <div className="flex justify-between mt-3">
                  Grand Total : <span>₹{(totalAmount + 99).toLocaleString('en-IN')}</span>
                </div>
                ...
                <div className="whitespace-nowrap flex items-center justify-between mt-4">
                  ...
                  <div className="px-4 py-2 continue rounded-lg text-white">
